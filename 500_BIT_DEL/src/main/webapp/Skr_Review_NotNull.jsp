	...
	<div>
		<table>
			...
			<tr>
				...
				<form action="skr_content_m.do" method="POST">
					<input type="hidden" name="s_id" value="${svo.s_id}">
					<input type="hidden" name="s_classification" value="${svo.s_classification}">
					<input type="hidden" name="r_id" value="${srvolist.r_id }">
					<input type="text" id="skr_content" name="skr_content" value="${srvolist.skr_content }">
					<input type="submit" id="reviewbutton"  value="답글수정">
				</form>
				</td>
			</tr>
			</from>
